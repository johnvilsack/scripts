...
.DESCRIPTION
  ...
  - Exports the returned `.value` array to `Get-Employees.csv` in the same folder.

.EXAMPLE
  PS> .\Get-Employees.ps1
#>
...
$uri = 'https://shippers-supply.acumatica.com/odata/Shippers%20Supply/_JV-GetEmployees'
try {
...
# -- Export to CSV --
$csvPath = Join-Path $PSScriptRoot 'Get-Employees.csv'
